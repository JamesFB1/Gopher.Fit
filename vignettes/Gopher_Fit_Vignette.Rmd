...
Below, we implement the Hypothesis_Test function using the tortoise data. The arguments this function requires are similar to those of the SE_CI function used earlier. However, this function requires an extra parameter called beta_1 that is the name of the parameter of interest for which we wish to test the null hypothesis for. 

```{r}

p_value <- Hypothesis_Test(my_data = tortoise, example = "tortoise", 
                           fitted_values = fitted_values_hyp, m = 3, 
