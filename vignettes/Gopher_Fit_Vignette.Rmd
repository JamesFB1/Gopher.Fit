...
## Gopher.Fit
This is an R package that can be used to fit the Poisson GLMM. It implements bootstrapping to compute standard errors and confidence intervals, as well as hypothesis testing.
